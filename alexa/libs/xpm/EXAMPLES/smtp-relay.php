...
$f = 'andres.salazar@leadis.co'; // from (Gmail mail address)
$t = 'tahito1987@gmail.com'; // to mail address
$p = 'andres000'; // Gmail password
...
$c = SMTP::connect('mail.gmail.com', 465, $f, $p, 'tls', 10) or die(print_r($_RESULT));
