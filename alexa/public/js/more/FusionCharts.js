...
FusionCharts(["private", "modules.renderer.flash",
	function() {
		var a = this,
			f = window,
			g = document,
...
FusionCharts(["private", "modules.renderer.js",
	function() {
		var a = this,
			f = window,
			g = document,
...
(function() {
	...
	if (typeof JSON.stringify !== "function") JSON.stringify = function(a, c, e) {
		...
		if (typeof e === "number")
			for (f = 0; f < e; f += 1) o += " ";
		else typeof e === "string" && (o = e); if ((b = c) && typeof c !== "function" && (typeof c !== "object" || typeof c.length !== "number")) throw Error("JSON.stringify");
		return g("", {
			"": a
		})
	};
				...
				var g = {
					...
					f = function(c) {
						...
						try {
							...
							} else g = new ActiveXObject("Microsoft.XMLDOM"), g.async = "false", g.loadXML(c); if (!g || !g.childNodes || !(g.childNodes.length === 1 && (h = g.childNodes[0]) && h.nodeName && (e = h.nodeName.toLowerCase()) && (e === "chart" || e === "map" || e === "graph"))) return f.errorObject = new TypeError("xml2json.parse()"), b;
							else if (e === "graph") {
...
FusionCharts(["private", "CSVDataHandler",
	function() {
		var a = this,
			f;
		f = function(a) {
