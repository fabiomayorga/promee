...
$.extend($.validator, {
	...
	messages: {
		...
		remote: "Este campo debe ser corregido.",
		...
		creditcard: "Ingrese un numero de tarjeta de credito valido.",
		equalTo: "Asegurese que los dos campos son iguales.",
		maxlength: $.validator.format("Ingrese maximo {0} caracteres."),
		minlength: $.validator.format("Ingrese minimo {0} caracteres."),
